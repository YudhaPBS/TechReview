                        ...
                        <div class="portfolio-details-slider swiper">
                            <div class="swiper-wrapper align-items-center">
                                ...
                                <div class="swiper-slide">
                                    <iframe width="800" height="450" src="https://www.youtube.com/embed/Q4bMAwryHOU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                                </div>
                ...
                <iframe width="800" height="450" src="https://www.youtube.com/embed/4BfzrZamHmw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    ...
                    <div class="col-md-4">
                        <div class="portfolio-info">
                            <h3>Review Detail</h3>
                            <ul>
                                <li><strong>Brand</strong>: Infinix</li>
                                <li><strong>Release Date</strong>: 14 Juni, 2023</li>
                                <li><strong>Price</strong>: Rs. 20,990</li>
                            </ul>
                            <button class="border-button"><a href="https://youtu.be/Q4bMAwryHOU" class="glightbox btn-watch-video"><i class="bi bi-play-circle"></i><span> Watch Video</span></a></button>
                        </div>

                    </div>
                    <div class="portfolio-description">
                        <h2 class="text-center">Brand Description</h2>
                        <p>Infinix has been gaining traction outside of its usual markets, mostly thanks to its excellent midrange offers. Along with sister companies Tecno and Itel, the Chinese Transsion Holding's maker has captured significant market share in Africa and South Asia and has been looking to expand its global reach.
                        </p>
                        <p>Today, we have the Infinix Note 30 in for review. To be clear, this is the 4G version, not the 5G model. The Note series is kind of the mid-range for Infinix. Note models are not quite as budget and entry-level as the Hot line and are actually closer in character to the company's higher-end Zero line.</p>

                        <div class="swiper-slide">
                            <img src="assets/img/portfolio/6x.png" alt="">
                        </div>
                    </div>
                    <p>The Note 30 brings a large 6.78-inch, 120Hz display to the table, a decent MediaTek Helio G99 chipset, alongside a large 5,000 mAh battery with 45W fast charging. The phone also has a stereo speaker setup tuned by JBL.</p>
                    <div class="swiper-slide">
                        <img src="assets/img/portfolio/6.1x.png" alt="">
                    </div>
                </div>
                <p>
                <p>The Infinix Note 30 comes in a standard two-piece box. A pretty sturdy one, which is appreciated, complete with a plastic cradle to hold the actual phone on the inside for extra security. We like the green color scheme Infinix has gone with. It is eye-catching. You also get plenty of hardware info about the phone right on the box, which we appreciate.</p>
            </div>
