                  ...
                  <img src="assets/img/portfolio/portfolio-3.jpg" alt="">
                    ...
                    <div class="col-lg-4">
                        <div class="portfolio-info">
                            ...
                            <ul>
                                <li><strong>Topic</strong>: Announcement</li>
                                <li><strong>Brand</strong>: Samsung</li>
                                <li><strong>News date</strong>: 09 June, 2023</li>
                                <li><strong>Main URL</strong>: <a
                                        href="https://www.gsmarena.com/galaxy_s23_fe_battery_certification_suggests_approaching_announcement-news-58828.php">www.gsmarena.com</a>
                                </li>
                            </ul>
                        </div>
                        <div class="portfolio-description">
                            <h2>
                            Galaxy S23 FE battery certification suggests approaching announcement </h2>
                            <p>
                            The long-awaited Samsung Galaxy S23 FE is one step closer to its launch with the latest proof being a battery 
                            certification listing from Safety Korea.
                            </p>
                        </div>
                    </div>
                    <div class="portfolio-description">
                        <h2 class="text-center">News Description</h2>
                        <p>The long-awaited Samsung Galaxy S23 FE is one step closer to its launch with the latest proof being a battery 
                            certification listing from Safety Korea. The battery in the listing bears the EB-BS711ABY model number which matches the SM-S711 
                            identifier for the Galaxy S23 FE seen in the past.
                             The battery cell is manufactured by Amperex but its capacity is not disclosed. Past specs rumors suggest a 4,500 mAh cell with 25W charging.
                        </p>
                    </div>
                    <p>Galaxy S23 FE is rumored to launch with Samsung's Exynos 2200 chipset globally, alongside 6/8GB of RAM and 128/256GB storage.
                         The back will likely house a 50 MP main camera. Galaxy S23 FE is expected to launch ahead of the Galaxy Z Fold5 and Z Flip5 which are scheduled 
                        to be unveiled in the last week of July so we should see official confirmation from Samsung sometime in the next weeks.</p>
                </div>
            </div>
            </div>
