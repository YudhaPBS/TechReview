...
<head>
    ...
    <title>Review Brand TechReview</title>
        ...
        <section id="breadcrumbs" class="breadcrumbs">
            <div class="container">
                ...
                <ol>
                    ...
                    <li><a href="brand.php"><span>Review</span> <i></i></a></li>
                    <li>Review Details</li>
                </ol>
        <h2>Samsung Galaxy A24 4G</h2>
          ...
          <div class="col-lg-8">
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <iframe width="800" height="450" src="https://www.youtube.com/embed/18fAyt0ZImc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>

                <!-- <div class="swiper-slide">
                <iframe width="800" height="450" src="https://www.youtube.com/embed/4BfzrZamHmw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
          ...
          <div class="col-md-4">
            <div class="portfolio-info">
              ...
              <ul>
                ...
                <li><strong>Release Date</strong>: 05 Mei, 2023</li>
                <li><strong>Price</strong>: Rs. 18,090</li>
              </ul>
              <button class="border-button"><a href="https://www.youtube.com/watch?v=18fAyt0ZImc" class="glightbox btn-watch-video"><i class="bi bi-play-circle"></i><span>   Watch Video</span></a></button>
            </div>
            
          </div>
          <div class="portfolio-description">
              <h2 class="text-center">Brand Description</h2>
              <p>The Samsung Galaxy A24 is probably the most affordable Samsung phone that makes sense getting. Unlike the A10 and A00 series, the Galaxy A20 lineup has produced some solid offers throughout the years, and the new A24 4G is shaping up as yet another one of those.
                </p>
            <p>If you are looking for an affordable phone with a fluid screen, good cameras, long-lasting battery life and an eye-catchy design - well, this is exactly what the Galaxy A24 offers. It sure isn't a fast phone, let alone gaming-friendly, but it looks like it could handle everything else very well.</p>
               
            <div class="swiper-slide">
                            <img src="assets/img/portfolio/5x.png" alt="">
                    </div>
            </div>
            <p>Let's start with the design. It's a traditional flat shape with two glossy panels and a matte frame. The 6.5-inch screen uses a 1080p Super AMOLED panel with a 90Hz refresh rate, which is a nice treat for this price bracket.</p>
                <div class="swiper-slide">
                            <img src="assets/img/portfolio/5.1x.png" alt="">
                    </div>
            </div>
            <p>
            <p>The Helio G99 chipset is nothing to brag about, really, but it has two fast CPU cores, so it should at least handle your usual Android apps well. We do appreciate the 5,000mAh battery, though, and we expect it to shine in combination with that chipset.</p>
        </div>
