                        ...
                        <div class="portfolio-details-slider swiper">
                            <div class="swiper-wrapper align-items-center">
                                ...
                                <div class="swiper-slide">
                                    <img src="assets/img/portfolio/6.1.png" alt="">
                                </div>
                ...
                <div class="swiper-slide">
                  <img src="assets/img/portfolio/portfolio-3.jpg" alt="">
                        ...
                        <div class="portfolio-info">
                            ...
                            <ul>
                                ...
                                <li><strong>Main URL</strong>: <a
                                        href="https://www.gsmarena.com/heres_what_mark_zuckerberg_thinks_of_apples_vision_pro-news-58825.php">www.gsmarena.com</a>
                                </li>
                            </ul>
                        </div>
                        <div class="portfolio-description">
                            <h2>
                            Mark Zuckerberg shares his thoughts on the Apple's Vision Pro </h2>
                            <p>
                    ...
                    <div class="portfolio-description">
                        ...
                        <p>So it's interesting to hear what Meta founder and CEO Mark Zuckerberg thinks of Apple's inaugural VR headset.
                        </p>
                        <p>During a meeting with Meta employees, Zuckerberg addressed Vision Pro in detail. He said that Apple didn't find "magical solutions" to the constraints of physics that Meta's teams haven't already explored.</p>
                        <p>He notes Apple's use of higher-resolution displays but adds that it requires more energy to power, a battery and a wire attached to use it, and the fact that it costs seven times more than the Quest 3.</p>
                        <div class="swiper-slide">
                            <img src="assets/img/portfolio/6.png" alt="">
                        </div>
                    </div>
                    <p>Perhaps most importantly, Zuckerberg talks about the "difference in the values and the vision" between Meta and Apple when it comes to their headsets. He adds that Meta's vision is "fundamentally social" and that "it's about people interacting in new ways and feeling closer in new ways". He continues that Apple's approach, by contrast, showed "a person sitting on a couch by themself". He finished off by saying that Apple's Vision Pro could be "the vision of the future of computing", "but like, it's not the one I want".</p>
                </div>
            </div>
            </div>
