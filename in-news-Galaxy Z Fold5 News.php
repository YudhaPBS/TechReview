    ...
    <header id="header" class="fixed-top header-inner-pages">
        <div class="container d-flex align-items-center">
            ...
            <ul>
                    ...
                    <li><a class="nav-link scrollto " href="news2.php">News</a></li>
                    <li><a class="nav-link scrollto" href="login.php" onclick="return confirmNavigation()"" class=" details-link" title="More Details">Review</a></li>
                    <br>
        ...
        <section id="breadcrumbs" class="breadcrumbs">
            <div class="container">
                ...
                <ol>
                    ...
                    <li><a href="news2.php"><span>News</span> <i></i></a></li>
                    <li>News Details</li>
                </ol>
        <h2>Galaxy Z Fold5 and Z Flip5 may get separate</h2>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Topic</strong>: Get Separate Launch Event </li>
                <li><strong>Brand</strong>: Samsung</li>
                <li><strong>News date</strong>: 09 June, 2023</li>
                <li><strong>Main URL</strong>: <a href="https://www.gsmarena.com/galaxy_z_fold5_and_z_flip5_may_get_separate_launch_event_for_north_america_in_august-news-58831.php">www.gsmarena.com</a></li>
              </ul>
            </div>
            <div class="portfolio-description">
              <h2>Galaxy Z Fold5 and Z Flip5 may get separate launch event for North America in August</h2>
              <p>
              Samsung has confirmed that it's holding its next Unpacked unveiling event in its home of Korea, in the last week of July</p>
            </div>
          </div>
          <div class="portfolio-description">
              <h2 class="text-center">News Description</h2>
              <p>Samsung has confirmed that it's holding its next Unpacked unveiling event in its home of Korea, in the last week of July. However, the plot now thickens, as a new report claims there will be a separate Unpacked event for the North American markets (the US and Canada), which will take place in August.
                </p>
                <p>Or rather, on August 11, to be precise. That would be a bit over two weeks after July 26, which is when the initial Unpacked is rumored to happen in Korea (Samsung still hasn't confirmed the actual date, for whatever reason).</p>
            </div>
            <p>TUnfortunately the source of this information hasn't
                 shared any more details, so we have no clue why Samsung would do things in this wa
                 y. This year is the first one when an Unpacked event is hosted in Korea, so we can't really set our expectations t
                 o go by what happened in the past. And it's fair to mention that this is just a rumor at this point. Let's see if it gets confirmed or not.</p>
                 <p>The Unpacked event at the end of July is widely expected to introduce the Galaxy Z Fold5, Galaxy Z Flip5, Galaxy Tab S9, Galaxy Tab S9+, Galaxy Tab S9 Ultra, Galaxy Watch6, and Galaxy Watch6 Classic/Pro.</p>
        </div>
