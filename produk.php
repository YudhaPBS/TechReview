...
//get data from database with id_produk
$id_produk = $_GET['id'];
$query = "SELECT * FROM chart_hp WHERE id_produk = $id_produk";
$result = mysqli_query($conn, $query);
$row = mysqli_fetch_assoc($result);

//update counter = counter + 1
$counter = $row['counter'] + 1;
$updateQuery = "UPDATE chart_hp SET counter = $counter WHERE id_produk = $id_produk";
