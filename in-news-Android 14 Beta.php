                  ...
                  <img src="assets/img/portfolio/portfolio-3.jpg" alt="">
                    ...
                    <div class="col-lg-4">
                        <div class="portfolio-info">
                            ...
                            <ul>
                                <li><strong>Topic</strong>: Update</li>
                                <li><strong>Brand</strong>: Android</li>
                                <li><strong>News date</strong>: 09 June, 2023</li>
                                <li><strong>Main URL</strong>: <a href="https://www.gsmarena.com/android_14_beta_3_packs_new_stulysspecific_features-news-58823.php">www.gsmarena.com</a>
                                </li>
                            </ul>
                        </div>
                        <div class="portfolio-description">
                            <h2>
                                Android 14 Beta 3 packs new stylus-specific features
                            </h2>
                            <p>
                                Android 14's third beta is out now and some of its features attract the attention of code tinkerers.
                            </p>
                        </div>
                    </div>
                    <div class="portfolio-description">
                        <h2 class="text-center">News Description</h2>
                        <p>The most interesting is a set of stylus-specific settings that might hint at Google's plans for a stylus for the Pixel Tablet (or dare we hope - the Pixel Fold).
                        </p>
                        <p>Code inside the Beta 3 reveals that the software will be able to recognize and set different functions
                            to the different buttons on a stylus. There's a code line for the primary button (the one closest to the tip),
                            for the secondary, a tertiary, and the tail button (the one near or at the top). You'll also be able to set the
                            software to ignore stylus button presses.</p>
                        <p>Android 14's Beta 3 allows you to launch the default note app with the tail button, as well as change which the default app is.</p>
                        <div class="swiper-slide">
                            <img src="assets/img/portfolio/8.1.png" alt="">
                        </div>
                    </div>
                    <mary>The expanded functionality could hint that Google is working on a stylus for the Pixel Tablet, which launched without mention of one, but does support the USI 2.0 (Universal Stylus Initiative) type stylus. mary camera, an 8MP ultrawide camera, 32MP selfie shooter, and 100W charging.</p>
                </div>
            </div>
            </div>
