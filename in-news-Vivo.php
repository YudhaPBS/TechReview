                  ...
                  <img src="assets/img/portfolio/portfolio-3.jpg" alt="">
                    ...
                    <div class="col-lg-4">
                        <div class="portfolio-info">
                            ...
                            <ul>
                                <li><strong>Topic</strong>: Vivo Close</li>
                                <li><strong>Brand</strong>: Vivo</li>
                                <li><strong>News date</strong>: 09 June, 2023</li>
                                <li><strong>Main URL</strong>: <a
                                        href="https://www.gsmarena.com/vivo_closes_its_german_online_store-news-58827.php">www.gsmarena.com</a>
                                </li>
                            </ul>
                        </div>
                        <div class="portfolio-description">
                            <h2>
                            vivo closes its German online store  </h2>
                            <p>
                            After Oppo and OnePlus stopped sales in Germany last summer, following a lawsuit from Nokia, vivo is now closing down its online store as well. 
                            Back in April, the German court ruled in favor of Nokia as vivo has apparently infringed a Nokia patent related to
                             the WLAN connections in vivo's smartphones. The same reason why Oppo and OnePlus had to temporarily pull out from the German market.
                            </p>
                        </div>
                    </div>
                    <div class="portfolio-description">
                        <h2 class="text-center">News Description</h2>
                        <p>Without much of a warning, vivo's website is now closed and German consumers can 
                            no longer buy a vivo smartphone in the country. The German branch now greets you with a short statement that vivo's p
                            roducts are not available at the moment, but existing vivo smartphone owners will still get customer service and software updates.
                        </p>
                    </div>
                    <p>Notably, the patent lawsuit comes from the Finnish branch of Nokia related to the equipment supplier and not HMD Global, which now runs Nokia's smartphone business.</p>
                </div>
            </div>
            </div>
